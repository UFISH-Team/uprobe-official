...
1. Read the [quickstart](./quickstart.md) guide for your first probe design
2. Review the [configuration](./configuration.md) guide to understand config files
3. Explore the [cli](./cli.md) reference for all available commands

::: info Note
If you encounter any issues during installation, please check our [troubleshooting](./troubleshooting.md) guide or open an issue on [GitHub](https://github.com/UFISH-Team/U-Probe/issues).
